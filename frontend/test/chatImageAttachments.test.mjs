...
test('chat input supports image attachment selection and multimodal submit payloads', () => {
  ...
  assert.equal(source.includes('conversationStore.setLastMessageAnalysisMetadata(response?.metadata || {}, localMessageId, { conversationId: requestConversationId })'), true)
})
