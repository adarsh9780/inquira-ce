...
test('api service persists API key via v1 preferences secure endpoint', () => {
  ...
  assert.equal(contract.includes('verifyKey: (provider: string, apiKey: string)'), true)
  assert.equal(generated.includes('/api/v1/preferences/verify-key'), true)
  ...
  assert.equal(generated.includes('/api/v1/preferences/api-key'), true)
