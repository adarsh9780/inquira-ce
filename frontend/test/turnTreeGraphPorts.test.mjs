...
test('turn tree graph renders explicit ports above flush node cards and keeps wheel zoom', () => {
  assert.equal(graphViewSource.includes('class="h-full" data-graph-interactive'), true)
  assert.equal(graphViewSource.includes('class="h-full p-0.5" data-graph-interactive'), false)
