...
test('chat input surfaces backend error detail instead of flattening 5xx into generic copy', () => {
  ...
  assert.equal(source.includes("conversationStore.updateLastMessageExplanation(streamErrorMessage, localMessageId, { conversationId: requestConversationId })"), true)
})
