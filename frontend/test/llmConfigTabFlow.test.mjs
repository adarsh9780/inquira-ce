...
test('useLLMConfig composable exposes provider-aware save flow and advanced fields', () => {
  ...
  assert.equal(source.includes('await apiService.v1SetApiKey(securePayload)'), true)
  assert.equal(source.includes('await apiService.v1UpdatePreferences(preferencePayload)'), true)
