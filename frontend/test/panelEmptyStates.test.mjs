...
test('analysis panels use short action-oriented empty states', () => {
  ...
  assert.equal(outputSource.includes('No run output'), true)
  assert.equal(outputSource.includes('Run code that prints a value, returns a scalar, or raises an error.'), true)
