...
test('analysis panels use short action-oriented empty states', () => {
  ...
  assert.equal(outputSource.includes('No other output'), true)
  assert.equal(outputSource.includes('Printed values, scalar results, and errors will appear here with the code that produced them.'), true)
