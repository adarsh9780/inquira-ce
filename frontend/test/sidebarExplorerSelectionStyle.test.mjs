...
test('sidebar renders minimal explorer style with compact brand active highlights', () => {
  ...
  assert.equal(unifiedSource.includes("font-normal text-[var(--color-text-main)]"), true)
  ...
  assert.equal(unifiedSource.includes('text-[18px] font-normal leading-none'), true)
})
