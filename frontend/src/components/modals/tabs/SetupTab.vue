...
const readinessItems = computed(() => {
  ...
  const steps = [
    ...
    { key: 'connection', label: 'Model connection', description: hasConnection ? 'The effective provider is connected.' : 'Connect a provider once for all workspaces.', complete: hasConnection, actionLabel: 'Connect model', action: () => appStore.openSettings('llm') },
