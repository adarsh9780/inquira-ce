        ...
        >
          <div class="flex h-20 overflow-hidden rounded-lg border" :style="{ borderColor: theme.preview[1] }">
            <div class="w-12 border-r px-2 py-2" :style="{ borderColor: theme.preview[1], backgroundColor: theme.preview[1] }">
              ...
              <div class="mt-2 h-1.5 w-7 rounded-full opacity-30" :style="{ backgroundColor: theme.preview[2] }"></div>
              <div class="mt-1.5 h-1.5 w-5 rounded-full opacity-30" :style="{ backgroundColor: theme.preview[2] }"></div>
            </div>
            <div class="flex-1 px-3 py-2" :style="{ backgroundColor: theme.preview[0] }">
              <div class="flex items-center justify-between">
                <div class="h-2 w-16 rounded-full opacity-30" :style="{ backgroundColor: theme.preview[2] }"></div>
