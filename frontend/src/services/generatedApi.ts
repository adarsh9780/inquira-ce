...
export type WorkspaceRuntimeActionResponseOk = boolean | null;

export type WorkspaceRuntimeActionResponseStatus = string | null;

export interface WorkspaceRuntimeActionResponse {
  workspace_id: string;
  reset: boolean;
  ok?: WorkspaceRuntimeActionResponseOk;
  status?: WorkspaceRuntimeActionResponseStatus;
}

export type WorkspaceRuntimeStatusResponseLastUsedAt = string | null;

export type WorkspaceRuntimeStatusResponseIdleSeconds = number | null;

export interface WorkspaceRuntimeStatusResponse {
  workspace_id: string;
  status: string;
  last_used_at?: WorkspaceRuntimeStatusResponseLastUsedAt;
  idle_seconds?: WorkspaceRuntimeStatusResponseIdleSeconds;
}
 ...
 */
const getWorkspaceRuntimeResourceRecommendationApiV1WorkspaceRuntimeResourceRecommendationGet = <TData = AxiosResponse<WorkspaceResourceRecommendationResponse>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
 ...
 */
const getWorkspaceRuntimeStatusEndpointApiV1WorkspacesWorkspaceIdRuntimeStatusGet = <TData = AxiosResponse<WorkspaceRuntimeStatusResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
 ...
 */
const bootstrapWorkspaceRuntimeEndpointApiV1WorkspacesWorkspaceIdRuntimeBootstrapPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
 ...
 */
const retryWorkspaceRuntimeEndpointApiV1WorkspacesWorkspaceIdRuntimeRetryPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
 ...
 */
const hardResetWorkspaceRuntimeEndpointApiV1WorkspacesWorkspaceIdRuntimeHardResetPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
 ...
 */
const interruptWorkspaceRuntimeApiV1WorkspacesWorkspaceIdRuntimeInterruptPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/api/v1/workspaces/${workspaceId}/runtime/interrupt`,undefined,options
    );
  }
 ...
 */
const resetWorkspaceRuntimeApiV1WorkspacesWorkspaceIdRuntimeResetPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/api/v1/workspaces/${workspaceId}/runtime/reset`,undefined,options
    );
  }
 ...
 */
const restartWorkspaceRuntimeApiV1WorkspacesWorkspaceIdRuntimeRestartPost = <TData = AxiosResponse<WorkspaceRuntimeActionResponse>>(
    workspaceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/api/v1/workspaces/${workspaceId}/runtime/restart`,undefined,options
    );
  }
