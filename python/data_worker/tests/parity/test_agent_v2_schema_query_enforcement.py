...
from inquira_data_worker.agent_v2.coding_subagent import AnalysisOutput
...
async def test_analysis_generate_code_reuses_enriched_sample_data_without_duplicate_sampling(
    ...
    monkeypatch.setattr("inquira_data_worker.agent_v2.nodes.sample_data", fake_sample_data)
