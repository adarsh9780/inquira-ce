...
test:
	go test ./...
	cd frontend && node --test test/firstRunModelOnboarding.test.mjs test/llmConfigTabFlow.test.mjs test/workspaceAiReadinessExperience.test.mjs test/localConnectionExperience.test.mjs test/nativeTurnArtifactApi.test.mjs
