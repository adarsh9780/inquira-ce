...
test:
	go test ./...
	cd frontend && node --test test/firstRunModelOnboarding.test.mjs test/llmConfigTabFlow.test.mjs test/workspaceAiReadinessExperience.test.mjs test/localConnectionExperience.test.mjs test/nativeTurnArtifactApi.test.mjs test/nativeCatalogCodeApi.test.mjs test/runtimeProvisioningExperience.test.mjs test/conversationUsageAndShortcuts.test.mjs
