...
$DefaultWheel = 'https://github.com/adarsh9780/inquira-ce/releases/download/v0.5.7a1/inquira_ce-0.5.7a1-py3-none-any.whl'
...
if "%INQUIRA_WHEEL_URL%"=="" set "INQUIRA_WHEEL_URL=https://github.com/adarsh9780/inquira-ce/releases/download/v0.5.7a1/inquira_ce-0.5.7a1-py3-none-any.whl"
...
'@
$CmdContent = $CmdContent -replace 'https://github.com/adarsh9780/inquira-ce/releases/download/v0.5.7a1/inquira_ce-0.5.7a1-py3-none-any.whl', [Regex]::Escape($WheelUrl)
