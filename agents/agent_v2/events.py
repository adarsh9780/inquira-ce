"""Shared event emitter for agent v2 runtime events."""
...
_AGENT_V2_EVENT_EMITTER: ContextVar[Callable[[str, dict[str, Any]], None] | None] = ContextVar(
    "_agent_v2_event_emitter",
    default=None,
)
