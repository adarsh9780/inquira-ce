...
agent-runtime service. This shim preserves existing dependency injection
...
class WorkspaceLangGraphManager:
    ...
    async def get_graph(self, workspace_id: str, agent_memory_path: Path) -> Any:
        ...
        raise RuntimeError(
            "Embedded LangGraph execution is disabled. Use the external agent-runtime API service."
        )
