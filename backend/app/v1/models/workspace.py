...
class WorkspaceDataset(AppDataBase):
    ...
    schema_status: Mapped[str] = mapped_column(String(32), nullable=False, default="queued", server_default="queued")
    schema_error_message: Mapped[str | None] = mapped_column(String(1024), nullable=True)
