...
## Deep Dives
Understand the specific sequence flows by opening the standalone diagrams below. 
By keeping them isolated, they are granted the full screen-width for maximum readability and zooming.

- **[🖥️ View End-to-End Agent Workflow Diagram](./workflow_diagram.md)**
- **[💾 View DuckDB Data Pipeline Diagram](./data_pipeline_diagram.md)**
