...
- **Persistent Local Workspaces**: Workspaces physically retain their database state across app closures—no re-uploads required.
...
network resources, and memory available to your user account. Review code before running it, use
trusted workspaces and prompts, and maintain backups of important data.
